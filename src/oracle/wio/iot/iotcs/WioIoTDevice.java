...
public class WioIoTDevice {
	...
	public void initiateDevice(String configFilePath, String configFilePassword)
		 ...
		 *
		 * Since there is only one attribute, maxThreshold, this could have done with
		 * using an attribute specific on change handler.
		 */
	...
	// keytool -import -alias ca -file somecert.cer -keystore cacerts -storepass
	// changeit [Return]
	// keytool -import -alias iot -file
	// /Users/alev/ApplicationIOT/OracleWioIOT/lib/iotserver.cer -keystore
