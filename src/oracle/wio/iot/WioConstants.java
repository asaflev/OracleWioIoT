...
public class WioConstants {
	...
	public final static String TEMPERATURE_INSTANCE_NAME = "GroveTempHumD1";
	...
	public final static String HUMIDITY_INSTANCE_NAME = "GroveTempHumD1";
	...
	static {
		try {
			WIO_IOT_DEVICE = (JSONArray) (new JSONParser()).parse("[\n" + "\n" + "  {\n" + "    \"type\": \"INPUT\",\n"
